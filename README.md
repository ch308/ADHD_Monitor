...
面向 ADHD（注意缺陷多动障碍）与自闭症谱系家庭的"边缘+云"陪伴方案，支持3种模式：
1.家庭版-多动症，手机 App 为中枢；毛绒球向 App 实时传输心率/压力；毛绒球与手环数据同步与预警推送；家长侧记录后向星星设备推送 AI 建议，并启动星星机器人（xiaozhi）的 AI 聊天对话模式
...
4. 教师版，手机 App 为中枢；老师和孩子分别佩戴手环，当心率异常时，老师会收到报警，并注明对应的孩子
